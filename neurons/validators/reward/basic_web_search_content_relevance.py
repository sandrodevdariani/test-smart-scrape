...
class BasicWebSearchContentRelevanceModel(BaseRewardModel):
    ...
    def check_response_random_link(self, response: WebSearchSynapse):
        try:
    ...
    async def get_rewards(
        self, responses: List[WebSearchSynapse], uids
